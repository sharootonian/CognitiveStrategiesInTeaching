...
from functions.features import get_feature_levels, get_feature_reward_sum_rmTraj
...
def preprocessing(trialSetup,simdata,RAW_DIR):
    ...
    for i in range(0,len(files)):
        ...
        for i in preprocessed_subj.index:
            ...
            #get true_advice_utility and convert ti simple nodes
            preprocessed_subj.at[i,'true_AU'] = coordToint(trial['true_advice_utility'].tolist()[0])
            preprocessed_subj.loc[i,'edge_utility_true'] =  preprocessed_subj.loc[i,'true_AU'][preprocessed_subj.loc[i,'edge']]
            ...
            preprocessed_subj.at[i,'true_maxUA'] = max_value_keys(preprocessed_subj.loc[i,'true_AU'])[0]
