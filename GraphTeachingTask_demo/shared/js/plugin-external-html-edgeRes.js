var jsPsychExternalHtml = (function (jspsych) {
    ...
    const info = {
        ...
        parameters: {
            ...
            edge_res: {
                type: jspsych.ParameterType.FUNCTION,
                pretty_name: "edge response",
                default: undefined,
            },
            current_correct_edge: {
                type: jspsych.ParameterType.FUNCTION,
                pretty_name: "Current correct edge",
                default: undefined,
            },
            current_index: {
                type: jspsych.ParameterType.FUNCTION,
                pretty_name: "Current index",
                default: undefined,
            },
            responsesLog: {
                type: jspsych.ParameterType.FUNCTION,
                pretty_name: "hitory of all the edges they clicked with RT",
                default: undefined,
            },
            currEdgeRTMS: {
                type: jspsych.ParameterType.FUNCTION,
                pretty_name: "RT of the final choice",
                default: undefined,
            },
            flipped: {
                type: jspsych.ParameterType.FUNCTION,
                pretty_name: "is this trial flipped?",
                default: undefined,
            },
            seed: {
                type: jspsych.ParameterType.FUNCTION,
                pretty_name: "seed used to simulate model",
                default: undefined,
            },
            ...
            fetch(url)
                ...
                const finish = () => {
                    ...
                    var trial_data = {
                        ...
                        url: trial.url,
                        edge: trial.edge_res(display_element),
                        edgeRT: trial.currEdgeRTMS(display_element),
                        flipped: trial.flipped(display_element),
                        correct_edge: trial.current_correct_edge(display_element),
                        index: trial.current_index(display_element),
                        edgeClickLog: trial.responsesLog(display_element),
                        seed: trial.seed(display_element),
                    };
